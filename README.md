...
| <a name="output_opensearch_client_security_group_id"></a> [opensearch\_client\_security\_group\_id](#output\_opensearch\_client\_security\_group\_id) | Security group id for the opensearch client. |
| <a name="output_opensearch_security_group_id"></a> [opensearch\_security\_group\_id](#output\_opensearch\_security\_group\_id) | Security group id for the opensearch. |
<!-- END_TF_DOCS -->
